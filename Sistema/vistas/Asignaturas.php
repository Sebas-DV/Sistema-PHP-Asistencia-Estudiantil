<?php
  ...
  {
    require_once '../procesos/Asignatura/asignatura.php';
          ...
          <div class="col-md-4">
            ...
            <form action="" method="POST">
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="asignatura"id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nombre de la Asignatura">
              </div>
          ...
          <div class="col-md-8">
            ...
            <div class="tabla-estudiantes">
              <table class="table">
                ...
                <tbody>
                  <?php
                    $sql = mysqli_query($conexionBD, "SELECT * FROM asignaturas");
                    ...
                    ?>
                      <tr>
                        ...
                        <td><button type="button" class="btn btn-outline-danger" onclick="eliminarAlertaAsig('<?php echo $data[0]; ?>')"><i class="fa fa-trash"></i> Eliminar</button></td>
                      </tr>
                    <?php
                      }
                    }
                      ...
                      <form role="form">
                          <div class="form-group">
                            <input type="text" name="" hidden="" id="id" value="">
                              <label for="inputName">Asignatura</label>
